...
### 方式一：直接运行 exe（推荐）
打包产物在 `dist/ClippyPet-v0.1/`，双击 `ClippyPet-v0.1.exe` 即可，**无需安装 Python**；整目录拷到其他电脑也能用。
...
```
- 产物：`dist/ClippyPet-v0.1/ClippyPet-v0.1.exe`（onedir，含全部皮肤素材）
...
├── ClippyPet-v0.1.spec   # PyInstaller 打包配置
